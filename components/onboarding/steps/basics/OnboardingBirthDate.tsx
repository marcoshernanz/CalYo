...
export default function OnboardingBirthDate() {
  ...
  const handleDayChange = (value: string) => {
    ...
    setData((prev) => ({
      ...prev,
      birthDate: new Date(date.getFullYear(), date.getMonth(), day).getTime(),
    }));
  };
  ...
  const handleMonthChange = (value: string) => {
    ...
    setData((prev) => ({
      ...prev,
      birthDate: new Date(date.getFullYear(), monthIndex, safeDay).getTime(),
    }));
  };
  ...
  const handleYearChange = (value: string) => {
    ...
    setData((prev) => ({
      ...prev,
      birthDate: new Date(year, date.getMonth(), safeDay).getTime(),
    }));
  };
