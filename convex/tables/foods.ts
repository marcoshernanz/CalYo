...
export const foodsFields = {
  ...
  microNutrients: v.object({}), // TODO: Keep it for backward compatibility
  nutrients: v.object({
    ...
    "25Hydroxycholecalciferol": v.optional(v.number()),
    ...
    "5MethylTetrahydrofolate5Mthf": v.optional(v.number()),
    folateDfe: v.optional(v.number()),
    "10FormylFolicAcid10hcofa": v.optional(v.number()),
    "5FormyltetrahydrofolicAcid5Hcoh4": v.optional(v.number()),
